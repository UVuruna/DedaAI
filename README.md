<!-- lang-ok: user-facing install guide, users are Serbian/Slovenian -->
# Deda 👓
...
> 🔑 **Prvo ti treba besplatan Google ključ.** Detaljan slikovni vodič (SR / SL / EN):
> **[Kako napraviti ključ → vodic.html](vodic.html)** — otvori u pregledaču.
...
4. U Settings (zupčanik gore desno) nalepi **svoj** Gemini API ključ (vidi
   vodič iznad) i izaberi jezik. Kad izađeš nazad (strelicom ili
   prevlačenjem), unos se sačuva.
